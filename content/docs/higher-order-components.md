...
HOC'lar Redux'un [`connect`](https://react-redux.js.org/api/connect) ve Relay'in [`createFragmentContainer`](https://relay.dev/docs/v10.1.3/fragment-container/#createfragmentcontainer) gibi üçüncü taraf React kütüphanelerinde yaygındır.
...
HOC’lar tarafından yaratılan kapsayan bileşenler, diğer bileşenler gibi [React Developer Tools](https://github.com/facebook/react/tree/main/packages/react-devtools) tarafından gösterilir. Debug işlemini kolaylaştırmak için, gösterilecek adı bu bileşenin bir HOC sonucu olduğunu belirtmesine özen gösterin.
