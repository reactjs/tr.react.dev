...
Yaygın bir alternative UI pattern, list’i update etmeyi *defer* etmek ve yeni result’lar ready olana kadar previous result’ları göstermeye devam etmektir. [`useDeferredValue`](/reference/react/useDeferredValue) Hook’u, query’nin deferred bir version’ını aşağıya pass etmenizi sağlar:
